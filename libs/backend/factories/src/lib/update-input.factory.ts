import { BaseModel, BaseObject, BaseObjectConstructor, Constructor, PropertiesMetadataManager } from "@garrettmk/class-schema";
 ...
 */
export type DefaultUpdateInput<Model extends BaseModel> = Partial<UpdatableFields<Model>>;
...
>(
    ...
    const propertiesMetadata = omitProperties(requireProperties(modelPropertiesMetadata, required), ['id', ...omitted]);
