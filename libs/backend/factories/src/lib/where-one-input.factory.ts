import { BaseObjectConstructor, Constraints, Constructor } from "@garrettmk/class-schema";
...
>(
    ...
    return GeneratedWhereOneInputClass as unknown as BaseObjectConstructor<WhereOneInput<T, K>>;
}