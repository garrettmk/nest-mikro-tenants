...
} from '@garrettmk/metadata-manager';
...
export class FilterTypesRegistry extends MetadataManagerClass<
  FilterTypeMetadata,
  Constructor
>(staticFilterMappings) {
...
export const isFilterableField: MetadataSelector<PropertyMetadata> = (
  metadata
) => {
